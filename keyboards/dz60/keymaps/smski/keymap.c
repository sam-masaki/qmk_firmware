...
[L_QG] = LAYOUT(
	...
	KC_LSFT, XXXXXXX, KC_Z,    KC_X,    KC_C,    KC_V,    KC_J,    KC_K,    KC_P,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT, DZ_CYCL,

	KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,           MO(L_TH),         KC_DEL,                    KC_RALT, MO(L_FN),XXXXXXX, MO(L_RG),KC_RCTL),
...
[L_QW] = LAYOUT(
	...
	KC_LSFT, XXXXXXX, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT, DZ_CYCL,
...
[L_NM] = LAYOUT(
	_______, _______, _______, _______, _______, _______, _______, KC_P7,   KC_P7,   KC_P7,   _______, _______, _______, _______, _______,

	_______, _______, _______, _______, _______, _______, _______, KC_P4,   KC_P5,   KC_P6,   _______, _______, _______,          _______,

	_______, _______, _______, _______, _______, _______, _______, KC_P1,   KC_P2,   KC_P3,   _______, _______,                    KC_ENT,

	_______, XXXXXXX, _______, _______, _______, _______, _______, _______, KC_P0,   _______, KC_PDOT, _______,          _______, _______,
...
[L_TH] = LAYOUT(
	...
	_______, _______, _______, _______,          _______,                   _______,          _______, XXXXXXX, XXXXXXX, XXXXXXX, _______),
...
[L_FN] = LAYOUT(
	...
	_______, XXXXXXX, _______, _______, _______, _______, _______, _______, DZ_QWER, DZ_QGML, _______, _______,          _______, _______,

	_______, _______, _______, _______,          XXXXXXX,                   _______,          _______, _______, XXXXXXX, XXXXXXX, _______),
...
[L_RG] = LAYOUT(
	RGB_TOG, RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_SW,RGB_M_SN,RGB_M_K, RGB_M_X, RGB_M_G, RGB_M_T, _______, _______, _______, XXXXXXX, RESET,

	DZ_HU_D, RGB_HUD, RGB_HUI, DZ_HU_I, _______, _______, _______, _______, _______, _______, _______, RGB_RMOD,RGB_MOD,          _______,

	DZ_SA_D, RGB_SAD, RGB_SAI, DZ_SA_I, _______, _______, _______, _______, _______, _______, _______, _______,                   DZ_DBUG,

	DZ_VA_D, XXXXXXX, RGB_VAD, RGB_VAI, DZ_VA_I, _______, _______, _______, _______, _______, _______, _______,          _______, _______,

	DZ_VERS, _______, _______, _______,          XXXXXXX,                   _______,          _______, XXXXXXX, XXXXXXX, _______, _______),
};
